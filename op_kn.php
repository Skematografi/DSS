    ...
    <div class="row">
        <div class="box">
            ...
            <thead>
				...
				<tbody>
					<?php
						$query = mysqli_query($mysql,"select * from data_kn") or die (mysqli_error());
            ...
            <thead>
				...
				<tbody>
					<?php
						$query = mysqli_query($mysql,"select * from atribut_kn") or die (mysqli_error());
						if(mysqli_num_rows($query) == 0)
						{
							echo "<b>Data Not Avaible</b>";
						}
            ...
            <thead>
				...
				<tbody>
					<?php
						$query = mysqli_query($mysql,"select * from nor_kn") or die (mysqli_error());
						if(mysqli_num_rows($query) == 0)
						{
							echo "<b>Data Not Avaible</b>";
						}
            ...
            <thead>
				...
				<tbody>
					<?php
						$query = mysqli_query($mysql,"select * from ranking_kn order by point desc") or die (mysqli_error());
						if(mysqli_num_rows($query) == 0)
						{
							echo "<b>Data Not Avaible</b>";
						}
