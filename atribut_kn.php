    ...
    <div class="row">
        <div class="box">
            ...
            <div class="text-center">
				<form action="controller/proses_kn.php" method="post" name="form" onSubmit="return validasi()">
					...
					<input type="number" max="50" name="motif" id="motif" onfocus="awal()" onblur="berhenti()" required/> %<br>
