    ...
    <div class="row">
        <div class="box">
            ...
            <thead>
				...
				<tbody>
					<?php
						$query = mysqli_query($mysql,"select * from data_velg") or die (mysqli_error());
            ...
            <thead>
				...
				<tbody>
					<?php
						$query = mysqli_query($mysql,"select * from atribut_velg") or die (mysqli_error());
						if(mysqli_num_rows($query) == 0)
						{
							echo "<b>Data Not Avaible</b>";
						}
            ...
            <thead>
				...
				<tbody>
					<?php
						$query = mysqli_query($mysql,"select * from nor_velg") or die (mysqli_error());
						if(mysqli_num_rows($query) == 0)
						{
							echo "<b>Data Not Avaible</b>";
						}
					...
					<tr>
						...
						<td><?php echo number_format($result['diameter'],2); ?></td>
            ...
            <thead>
				...
				<tbody>
					<?php
						$query = mysqli_query($mysql,"select * from ranking_velg order by point desc") or die (mysqli_error());
						if(mysqli_num_rows($query) == 0)
						{
							echo "<b>Data Not Avaible</b>";
						}
