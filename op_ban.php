    ...
    <div class="row">
        <div class="box">
            ...
            <thead>
				...
				<tbody>
					<?php
						$query = mysqli_query($mysql,"select * from data_ban") or die (mysqli_error());
            ...
            <thead>
				...
				<tbody>
					<?php
						$query = mysqli_query($mysql,"select * from atribut_ban") or die (mysqli_error());
						if(mysqli_num_rows($query) == 0)
						{
							echo "<b>Data Not Avaible</b>";
						}
            ...
            <thead>
				...
				<tbody>
					<?php
						$query = mysqli_query($mysql,"select * from nor_ban") or die (mysqli_error());
						if(mysqli_num_rows($query) == 0)
						{
							echo "<b>Data Not Avaible</b>";
						}
					...
					<tr>
						...
						<td><?php echo  number_format($result['ukuran'],2); ?></td>
            ...
            <thead>
				...
				<tbody>
					<?php
						$query = mysqli_query($mysql,"select * from ranking_ban order by point desc") or die (mysqli_error());
						if(mysqli_num_rows($query) == 0)
						{
							echo "<b>Data Not Avaible</b>";
						}
