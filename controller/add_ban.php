...
<div class="container">
    <div class="row">
        <div class="box">
            ...
            <div class="atribut">
				<form action="DB_ban.php" method="post">
				<div class="col-sm-4 text-center">
					...
					<select style="width:200px; height : 30px; border : 50px 5px; background-color : #efeeef;" name="ukuran1" required/>
						...
						<option value="40">200 inchi</option>
						<option value="30">225 inchi</option>
						<option value="20">250 inchi</option>
					...
					<select style="width:200px; height : 30px; border : 50px 5px; background-color : #efeeef;" name="type1" required/>
						<option selected disabled> </option>
						<option value="30">Tubles</option>
						<option value="15">Biasa</option>
					</select><br>
					...
					<select style="width:200px; height : 30px; border : 50px 5px; background-color : #efeeef;" name="motif1" required/>
						...
						<option value="10">Kurang Menarik</option>
					</select><br>
