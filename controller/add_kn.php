...
<div class="container">
    <div class="row">
        <div class="box">
            ...
            <div class="atribut">
				<form action="DB_kn.php" method="post">
				<div class="col-sm-4 text-center">
					...
					<select style="width:200px; height : 30px; border : 50px 5px; background-color : #efeeef;" name="ukuran1" required/>
						...
						<option value="35">Racing</option>
						<option value="25">Custome</option>
						<option value="15">Standart</option>
					</select><br>

					<label>Type</label><br>
					<select style="width:200px; height : 30px; border : 50px 5px; background-color : #efeeef;" name="type1" required/>
						<option selected disabled> </option>
						<option value="45">Tsugi</option>
						<option value="35">Bobok</option>
						<option value="25">Bobok Sketan</option>
						<option value="15">Standart</option>
						<option value="10">Lain-lain</option>
					</select><br>

					<label>Warna Leher</label><br>
					<select style="width:200px; height : 30px; border : 50px 5px; background-color : #efeeef;" name="motif1" required/>
						<option selected disabled> </option>
						<option value="45">Rainbow</option>
						<option value="35">Chrome</option>
						<option value="25">Stainless Steel</option>
