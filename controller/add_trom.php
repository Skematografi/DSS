...
<div class="container">
    <div class="row">
        <div class="box">
            ...
            <div class="atribut">
				<form action="DB_trom.php" method="post">
				<div class="col-sm-4 text-center">
					...
					<select style="width:200px; height : 30px; border : 50px 5px; background-color : #efeeef;" name="ukuran1" required/>
						...
						<option value="40">Blimbing</option>
						<option value="30">Becak</option>
					...
					<select style="width:200px; height : 30px; border : 50px 5px; background-color : #efeeef;" name="motif1" required/>
						<option selected disabled> </option>
						<option value="30">Custome</option>
						<option value="20">Standart</option>
						<option value="10">Lain-lain</option>
					</select><br>
					...
					<select style="width:200px; height : 30px; border : 50px 5px; background-color : #efeeef;" name="type1" required/>
						...
						<option value="35">Chrome</option>
						<option value="25">Air Brush</option>
            ...
            <div class="row">
                <div class="text-center">
                    <p>Copyright &copy; <a href='http://Mothai.xyz'target="_blank">MoThai Style</a> 2017<br>
						<small><a href='http://stmik.ipem.ac.id'target="_blank">STMIK Insan Pembangunan Bitung</a> | Sistem Informasi 5 D | <a href='https://id.wikipedia.org/wiki/Sistem_pendukung_keputusan'target="_blank">Decision Support System</a></small>
					</p>
                </div>
            </div>
        </div>
